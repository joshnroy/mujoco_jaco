...
class Brain:
        ...
        def __init__(self):
                self.encoder = load_model(WEIGHTS_FILE)
                ...
                self.csvfile = open("stylegan_a3c_history.csv", 'w')
        ...
        def optimize(self):
                ...
                if self.frame_count % (len(s) * 3) == 0:
                    self.model.save_weights("stylegan_a3c.h5", overwrite=True)
